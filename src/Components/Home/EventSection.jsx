...
const timelines = [
  {
    ...
    desc1:'In order to motivate the kids, Thambatty Vivekanandar Illaignar Narpani Mandram organized three games as a start up for the new society club at Thambatty. Many kids from the village participated and the prizes were distributed by the elder people from Thambatty. Carrom, chess, Badminton was conducted.',
